# Creazione Icone App SumUp
Write-Host "========================================"
Write-Host "   Creazione Icone App SumUp"
Write-Host "========================================"
Write-Host ""

Write-Host "Creazione icone semplici per l'app SumUp Payment..."
Write-Host ""
...
Write-Host ""
Write-Host "========================================"
Write-Host "   ICONE CREATE CON SUCCESSO!"
Write-Host "========================================"
Write-Host ""
Write-Host "Le icone sono state create per tutte le densità."
Write-Host "Ora puoi buildare l'app!"
Write-Host ""