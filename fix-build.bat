@echo off
echo ========================================
echo    Fix Build Issues - SumUp App
echo ========================================
echo.
...
echo ========================================
echo    Pulizia Cache e Fix Build
echo ========================================
echo.

echo 1. Pulizia cache Gradle...
...
echo.
echo 2. Pulizia cache di configurazione...
if exist ".gradle\configuration-cache" (
    rmdir /s /q ".gradle\configuration-cache"
    echo Cache di configurazione rimossa
) else (
    echo Nessuna cache di configurazione trovata
)
